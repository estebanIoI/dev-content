...
<section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
              ...
              {/* Lanyard disembunyikan di mobile */}
            ...
            <section
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  {/* CHANGE: Mengubah tinggi kontainer Spline secara responsif */}
                ...
                <motion.div
                  ...
                  className="md:w-1/2 text-white text-center md:text-left px-4 md:px-8"
                >
                  <p className="text-2xl text-gray-300 font-moderniz my" style={{
                    textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc"
                  }}>Hello, I'm</p>
                  <h3 className="text-4xl font-bold text-white my-2 font-moderniz" style={{
                    textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc"
            ...
            {/* BAGIAN FOOTER dengan background glassmorphism dan shadow atas full width*/}
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">
                © {new Date().getFullYear()} Zain Ahmad Fahrezi. All rights reserved.
              </div>

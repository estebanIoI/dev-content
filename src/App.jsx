        ...
        <div className="relative min-h-screen bg-[#060010] overflow-hidden">
          ...
          <main className="relative z-10 px-8 max-w-7xl mx-auto">
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
              ...
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                <motion.h1 initial={{ opacity: 0, x: -60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.25, ease: "easeOut" }} className="text-4xl md:text-4xl font-moderniz font-bold leading-tight select-none" style={{ color: "#00ffdc", textShadow: `2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc` }}>
                    BIENVENIDO A Dev
                    <span style={{ display: 'block', marginTop: '0.4em' }}>Content</span>
                </motion.h1>
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55, ease: "easeOut" }}>
                    <TextGenerateEffect words={'Creación de sitios web responsivos y visualmente atractivos usando React, Tailwind CSS y tecnologías web modernas.'} />
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                    <a href="https://github.com/ZainAhmadF28" target="_blank" rel="noopener noreferrer" aria-label="Perfil de GitHub" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaGithub className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://instagram.com/zain.ahmadf" target="_blank" rel="noopener noreferrer" aria-label="Perfil de Instagram" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaInstagram className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://linkedin.com/in/zainahmadfahrezi" target="_blank" rel="noopener noreferrer" aria-label="Perfil de LinkedIn" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
            ...
            >
              ...
              <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-center">
                    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden mb-20">
                        <VelocityScroll defaultVelocity={3} numRows={1} className="max-w-full">
                            <span className="font-moderniz font-bold" style={{ fontSize: "2.5rem", lineHeight: "1.1", color: "#00ffdc", textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc", background: "none", WebkitBackgroundClip: "unset", WebkitTextFillColor: "unset", animation: "none"}}>
                                ACERCA <span style={{ color: "#fff" }}>DE NOSOTROS</span>
                            </span>
                        </VelocityScroll>
                    ...
                    <p className="text-lg text-cyan-200/70 mt-2 font-cascadia px-1 mb-20">
                        ✧ Apasionados por la programación y la tecnología creativa ✧
                    </p>
                </motion.div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  <p className="text-2xl text-gray-300 font-moderniz my" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" }}>Hola, somos</p>
                  <h3 className="text-4xl font-bold text-white my-2 font-moderniz" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" }}>Dev Content</h3>
                  <p className="text-white/80 leading-relaxed mt-4 font-cascadia text-justify">
                    En Dev Content somos un equipo de cuatro programadores full stack apasionados por la tecnología, especializados en el diseño y desarrollo de páginas web y aplicaciones modernas. Nuestro propósito es transformar ideas en soluciones digitales funcionales, creativas y escalables.
                  </p>
            ...
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">© {new Date().getFullYear()} Dev Content. Todos los derechos reservados.</div>
              <div className="text-xs mt-2">Construido con <span className="text-red-500">♥</span> usando React, Tailwind CSS y Framer Motion.</div>
            </footer>
          </main>
        </div>
      </NavbarProvider>

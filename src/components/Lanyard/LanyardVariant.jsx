...
export default function LanyardVariant({ 
  position = [0, 0, 30], 
  gravity = [0, -40, 0], 
  fov = 20, 
  transparent = true,
  variant = 1 // 1-4 para diferentes variantes
}) {
  return (
...
function Band({ maxSpeed = 50, minSpeed = 0, variant = 1 }) {
  ...
  // Seleccionar textura basada en la variante
  const getLanyardTexture = () => {
    switch(variant) {
      case 1:
        return lanyard1;
      case 2:
  ...
  // Obtener color basado en la variante
  const getBandColor = () => {
    switch(variant) {
      case 1:
        return "white";
  ...
  // Obtener propiedades del material de la tarjeta basado en la variante
  const getCardMaterial = () => {
    switch(variant) {
      case 1:
        return { roughness: 0.9, metalness: 0.8, clearcoat: 1 };
      case 2:
        return { roughness: 0.5, metalness: 0.9, clearcoat: 0.8 };
      case 3:
        return { roughness: 0.7, metalness: 0.6, clearcoat: 1.2 };
      case 4:
        return { roughness: 0.3, metalness: 1.0, clearcoat: 0.9 };
      default:
        return { roughness: 0.9, metalness: 0.8, clearcoat: 1 };
    }
  };

  const cardMaterialProps = getCardMaterial();
          ...
          <group
            ...
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial 
                ...
                roughness={cardMaterialProps.roughness} 
                metalness={cardMaterialProps.metalness} 
              />
            </mesh>
